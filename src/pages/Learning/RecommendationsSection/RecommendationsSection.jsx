        ...
        <div className="bg-[#F5FFF1] mt-6">
            <div className="container mx-auto py-16 text-center">
                ...
                <div className="text-center">
                    <a href="https://coda.io/d/Beautiful-Brain-Recommendations_dYsd69q9uGd/Beautiful-Brain-Recommendations_sux-u" className="inline-block bg-[#24B260] hover:text-black text-white font-bold py-4 px-6 rounded-full transition duration-300">CHECKOUT MY RECOMMENDATIONS</a>
                </div>
            </div>
        </div>
    );
