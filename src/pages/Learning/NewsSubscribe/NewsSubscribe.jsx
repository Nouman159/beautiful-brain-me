            ...
            <div className="md:w-3/5 md:ml-12 md:h-96 flex flex-col justify-center items-center border-solid border-2 border-gray-300">
                <div className="w-full flex justify-center items-center">
                    <a href="https://beautifulbrain.substack.com/">
                        <img className="h-24 w-24" src="https://substackcdn.com/image/fetch/w_170,c_limit,f_auto,q_auto:best,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F26065e5d-14ec-455c-9dcf-8abe6e05b317_458x458.png" alt="" />
                    </a>
                </div>
                <a href="https://beautifulbrain.substack.com/" className="text-center font-bold text-xl my-2">Brain Snacks</a>
                ...
                <div className="w-full flex justify-center items-center mt-4">
                    <div className="w-72 md:w-auto flex items-center">
                        <input type="email" className="h-12 w-full md:w-48 px-4 border-2 border-blue-300 rounded-l outline-none md:mb-0" placeholder="Type your email..." />
                        <a href='https://beautifulbrain.substack.com/'>
                            <button className="h-12 w-full md:w-24 bg-blue-500 text-white rounded-r hover:bg-blue-600">Subscribe</button>
                        </a>
                    </div>
                </div>

                <div className="text-sm text-gray-500 mt-2 max-sm:mx-4">
                    By subscribing you agree <a href="https://substack.com/tos" className="text-blue-500">Substack's Terms of Use</a>, <a href='https://substack.com/privacy' className="text-blue-500">our Privacy Policy</a> and <a href="https://substack.com/ccpa?utm_source=embed_publication#personal-data-collected" className="text-blue-500">our Information collection notice</a>
                </div>
