        ...
        <div className="space-y-8 mb-12">
            <div className="flex flex-col md:flex-row justify-between mb-8">
                <div className="flex-1 p-6 md:ml-28">
                    <h2 className="text-7xl md:text-8xl font-semibold font-sans mb-2">
                        Coaching, <br /> from first <br /> principles
                    </h2>
                    <p className="text-lg leading-8 text-gray-600 pt-10 pb-6">
                    ...
                    <a href="https://calendly.com/jose_miguel_santos/coaching-discovery-call-beautiful-brain">
                        <button className="bg-[#5FBAE6] text-white py-5 px-8 text-lg rounded-full mt-3">
                            BOOK INTRO CALL
                        </button>
                    </a>
                </div>
            ...
            <div className="flex flex-col md:flex-row mb-8">
                ...
                <div className="flex-1 p-6 md:mt-32 md:ml-[-100px]">
                    <h3 className="text-5xl font-sans mb-2">
