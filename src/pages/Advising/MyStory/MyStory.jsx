...
const MyStory = () => {
    return (
        <div className="container w-full mx-auto p-4 bg-[#FFF2F1]">
            <img
            ...
            <div className="flex flex-col md:flex-row justify-around items-start max-sm:ml-2 mt-8">
                <div className="md:w-1/2 text-left p-4 md:pl-0 md:pr-8">
                    <h3 className="text-4xl max-sm:text-3xl font-semibold mb-4">
                ...
                <div className="md:w-1/2 text-left p-4 md:pl-8 ">
                    ...
                    <h2 className="text-xl md:text-xl my-4 font-semibold">
