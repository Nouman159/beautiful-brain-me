...
const ValuesSection = () => {
    return (
        <div className="pl-3 pr-3 md:pl-4 md:pr-4 py-24">
            <h2 className="text-5xl font-bold mb-6 pl-14 md:ml-6 max-sm:pl-6">My values</h2>
            <div className="flex flex-col md:flex-row justify-around items-start space-y-6 md:space-y-0 pl-8 max-sm:pl-4">
                ...
                <div className="text-left pl-3 md:pl-4">
                    ...
                    />
                    <h3 className="text-[28px] font-bold mb-2">Diversity</h3>
                ...
                <div className="text-left pl-3 md:pl-4">
                    <img
                        ...
                        className="block mb-4"
                    />
                    <h3 className="text-[28px] font-bold mb-2">Lifelong learning</h3>
                    <p className="text-lg text-gray-600">
                ...
                <div className="text-left pl-3 md:pl-4">
                    <img
                        ...
                        className="block mb-4"
                    />
                    <h3 className="text-[28px] font-bold mb-2">Stoicisim</h3>
                    <p className="text-lg text-gray-600">
                ...
                <div className="text-left pl-3 md:pl-4">
                    <img
                        ...
                        className="block mb-4"
                    />
                    <h3 className="text-[28px] font-bold mb-2">Flexibility</h3>
                    <p className="text-lg text-gray-600">
