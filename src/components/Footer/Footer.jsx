            ...
            <div className="container mx-auto px-4 md:px-24">
                <div className="flex flex-wrap justify-between">
                    ...
                    <div className="w-full md:w-1/3 mb-8 md:mb-0">
                        ...
                        <p className="text-sm md:text-base">Beautiful Brain is the platform to help humans live their best selves.</p>
                    </div>
                    ...
                    <div className="w-full md:w-1/6">
                        <ul className="text-sm md:text-base">
                            ...
                            <li className="mb-3 md:mb-4">
                                <a href="/building" className="text-black hover:text-blue-500">BUILDING</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="w-full md:w-1/6">
                        <ul className="text-sm md:text-base">
                            <li className="mb-3 md:mb-4">
                                <a href="/learning" className="text-black hover:text-blue-500">LEARNING</a>
                            </li>
                            <li className="mb-3 md:mb-4">
                                <a href="/coaching" className="text-black hover:text-blue-500">COACHING</a>
                            </li>
                            <li className="mb-3 md:mb-4">
                                <a href="/advising" className="text-black hover:text-blue-500">ADVISING</a>
                            </li>
                        </ul>
                    </div>
